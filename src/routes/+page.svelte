...
<main class="container mx-auto max-w-md p-8">
	<div id="pdf-content">
		<h1 class="mb-4 text-center text-3xl font-bold">The chad time save Liquidity Calculator</h1>
		<h3 class="mb-3 text-center text-xl font-semibold">dont ask me stupid questions idiot!!!</h3>
		...
		<div class="space-y-4">
			...
			<div>
				<label class="mb-2 block text-sm font-medium" for="solicitors-fees">Solicitors fees:</label>
				<input
					type="number"
